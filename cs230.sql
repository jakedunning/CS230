...
--
-- Host: localhost:3306
-- Generation Time: Mar 26, 2021 at 08:18 PM
...
CREATE TABLE `profiles` (
  ...
  `profpic` varchar(50) NOT NULL DEFAULT '../images/morty.jpeg'
) ENGINE=InnoDB DEFAULT CHARSET=utf16;
...
(1, 'a', 'aa', '../images/morty.jpeg'),
(2, 'Jim', 'jjhalp', '../images/morty.jpeg'),
(3, 'a', 'ab', '../images/morty.jpeg');
...
(1, 'a', 'a', 'aa', '$2y$10$0R1PEYzk5W8mazuYWMieWu90ONOERbnGBwaC7oAKlwQs6hWcetnxy', 'aa@a.com'),
(2, 'Jim', 'Halpert', 'jjhalp', '$2y$10$hZLse1nk3eP8LSvWnvV0SeW.tICiALg9.HD0ZT0UdxK2B5nAhUSHu', 'jjhalp23@DunderMifflin.net'),
(3, 'a', 'a', 'ab', '$2y$10$e7W62nLB6MHjqWw/wvFwhezmQ2HMmMCrA1D1/T5EoGJ4Y9Dnv4TWC', 'abc@abc.net');
